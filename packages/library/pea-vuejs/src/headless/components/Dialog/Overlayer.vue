...
export interface OverlayerDialogProps extends PrimitiveProps {
  class?: string;
}
</script>
...
const props = withDefaults(defineProps<OverlayerDialogProps>(), {
  as: "div",
});
...
const bindings = computed(() => {
  const bindings: Record<string, any> = {
    id: `dialog-overlayer-${options?.id}`,
  };
